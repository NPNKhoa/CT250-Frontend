...
const Alert = ({ message, type }) => {
  ...
  return (
    <div className="fixed bottom-4 right-4 p-1 transition-opacity duration-500 ease-in-out" role="alert" tabIndex="-1">
      <div className="flex items-center border p-4 rounded-lg bg-white shadow-lg">
        <div className="shrink-0">
          <span className={`inline-flex justify-center items-center size-8 rounded-full border-4 ${bgColor}`}>
            {icon}
          </span>
        </div>
        <div className="ms-3">
