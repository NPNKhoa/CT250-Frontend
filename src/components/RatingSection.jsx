        ...
        <div className='mt-2'>
          ...
          <p className='mt-1 font-semibold '>
            ...
            <span className='text-gray-700 font-thin '>
              Nếu anh em nào chưa biết thì ShopVNB có kênh Youtube là Cộng đồng
              Cầu lông Việt Nam – VN Badminton chuyên review vợt và nhiều thể
              loại khác đấy nhé! Lên đây được xem test vợt, đo thông số đảm bảo
              anh em sẽ chọn được một cây vợt phù hợp với bản thân giống như
              mình luôn.
            </span>
          </p>
        </div>
